...
namespace WindowsFormsApp1.hethong.ADMIN.SuKien
{
    public partial class TrinhDo : Form
    {
        ...
        private void TrinhDo_Load(object sender, EventArgs e)
        {
            ...
            string query = "SELECT TrinhDoID, NDtrinhdo FROM [TRINHDO]"; // Chỉ lấy những cột cần thiết
        ...
        private void AddColumnsToDataGridView()
        {
            ...
            if (dataGridView_DanhSach.Columns.Count == 0)
            {
                ...
                colLuatID.Name = "TrinhDoID";
                colLuatID.HeaderText = "Mã Mục Đích";
                colLuatID.Width = 50;
                colLuatID.DataPropertyName = "TrinhDoID";  // Đảm bảo này khớp với tên cột trong DataTable
                dataGridView_DanhSach.Columns.Add(colLuatID);

                // Thêm cột "NoiDung"
                DataGridViewTextBoxColumn colNoiDung = new DataGridViewTextBoxColumn();
                colNoiDung.Name = "NDtrinhdo";
                colNoiDung.HeaderText = "Nội Dung";
                colNoiDung.Width = 250;
                colNoiDung.DataPropertyName = "NDtrinhdo"; // Đảm bảo này khớp với tên cột trong DataTable
        ...
        private void dataGridView_DanhSach_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            if (e.RowIndex >= 0)
            {
                ...
                if (row.Cells["TrinhDoID"].Value != null && row.Cells["NDtrinhdo"].Value != null)
                {
                    // Hiển thị giá trị vào các TextBox
                    guna2TextBox_IDSuKien.Text = row.Cells["TrinhDoID"].Value.ToString();
                    guna2TextBox_NDSuKien.Text = row.Cells["NDtrinhdo"].Value.ToString();
        ...
        private void guna2Button_Them_Click(object sender, EventArgs e)
        {
            ...
            string checkQuery = $"SELECT COUNT(*) FROM [TRINHDO] WHERE TrinhDoID = '{mucDichID}' OR NDtrinhdo = N'{ndMucDich}'";
            ...
            try
            {
                ...
                string insertQuery = $"INSERT INTO [TRINHDO] (TrinhDoID, NDtrinhdo) VALUES ('{mucDichID}', N'{ndMucDich}')";
        ...
        private void guna2Button_SuaLuat_Click(object sender, EventArgs e)
        {
            ...
            string checkQuery = $"SELECT COUNT(*) FROM [TRINHDO] WHERE NDtrinhdo = N'{ndMucDich}' AND TrinhDoID != '{mucDichID}'";
            ...
            try
            {
                ...
                string updateQuery = $"UPDATE [TRINHDO] SET NDtrinhdo = N'{ndMucDich}' WHERE TrinhDoID = '{mucDichID}'";
        ...
        private void guna2Button_XoaLuat_Click(object sender, EventArgs e)
        {
            ...
            if (dialogResult == DialogResult.Yes)
            {
                ...
                string query = $"DELETE FROM [TRINHDO] WHERE TrinhDoID = '{luatID}'";
        ...
        private void TimKiem()
        {
            ...
            string query = "SELECT TrinhDoID, NDtrinhdo FROM [TRINHDO]";
            ...
            dv.RowFilter = string.Format("TrinhDoID LIKE '%{0}%' OR NDtrinhdo LIKE '%{0}%'", searchKeyword); // Lọc theo LuatID và NoiDung
