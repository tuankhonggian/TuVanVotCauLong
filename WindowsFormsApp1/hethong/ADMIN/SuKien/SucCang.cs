...
{
    public partial class SucCang : Form
    {
        ...
        private void SucCang_Load(object sender, EventArgs e)
        {
            // Câu lệnh SQL để lấy dữ liệu từ bảng TapLuat
            string query = "SELECT SucCangID, NDsuccang FROM [SUCCANG]"; // Chỉ lấy những cột cần thiết
        ...
        private void AddColumnsToDataGridView()
        {
            ...
            if (dataGridView_DanhSach.Columns.Count == 0)
            {
                ...
                colLuatID.Name = "SucCangID";
                colLuatID.HeaderText = "Mã Mục Đích";
                colLuatID.Width = 50;
                colLuatID.DataPropertyName = "SucCangID";  // Đảm bảo này khớp với tên cột trong DataTable
                dataGridView_DanhSach.Columns.Add(colLuatID);

                // Thêm cột "NoiDung"
                DataGridViewTextBoxColumn colNoiDung = new DataGridViewTextBoxColumn();
                colNoiDung.Name = "NDsuccang";
                colNoiDung.HeaderText = "Nội Dung";
                colNoiDung.Width = 250;
                colNoiDung.DataPropertyName = "NDsuccang"; // Đảm bảo này khớp với tên cột trong DataTable
        ...
        private void dataGridView_DanhSach_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            if (e.RowIndex >= 0)
            {
                ...
                if (row.Cells["SucCangID"].Value != null && row.Cells["NDsuccang"].Value != null)
                {
                    // Hiển thị giá trị vào các TextBox
                    guna2TextBox_IDSuKien.Text = row.Cells["SucCangID"].Value.ToString();
                    guna2TextBox_NDSuKien.Text = row.Cells["NDsuccang"].Value.ToString();
        ...
        private void guna2Button_Them_Click(object sender, EventArgs e)
        {
            ...
            string checkQuery = $"SELECT COUNT(*) FROM [SUCCANG] WHERE SucCangID = '{mucDichID}' OR NDsuccang = N'{ndMucDich}'";
            ...
            try
            {
                ...
                string insertQuery = $"INSERT INTO [SUCCANG] (SucCangID, NDsuccang) VALUES ('{mucDichID}', N'{ndMucDich}')";
        ...
        private void guna2Button_SuaLuat_Click(object sender, EventArgs e)
        {
            ...
            string checkQuery = $"SELECT COUNT(*) FROM [SUCCANG] WHERE NDsuccang = N'{ndMucDich}' AND SucCangID != '{mucDichID}'";
            ...
            try
            {
                ...
                string updateQuery = $"UPDATE [SUCCANG] SET NDsuccang = N'{ndMucDich}' WHERE SucCangID = '{mucDichID}'";
        ...
        private void guna2Button_XoaLuat_Click(object sender, EventArgs e)
        {
            ...
            if (dialogResult == DialogResult.Yes)
            {
                ...
                string query = $"DELETE FROM [SUCCANG] WHERE SucCangID = '{luatID}'";
        ...
        private void TimKiem()
        {
            ...
            string query = "SELECT SucCangID, NDsuccang FROM [SUCCANG]";
            ...
            dv.RowFilter = string.Format("SucCangID LIKE '%{0}%' OR NDsuccang LIKE '%{0}%'", searchKeyword); // Lọc theo LuatID và NoiDung
