...
{
    public partial class TrongLuongVung : Form
    {
        ketnoiDN ketnoi = new ketnoiDN();
        public TrongLuongVung()
        {
            InitializeComponent();
        ...
        private void TrongLuongVung_Load(object sender, EventArgs e)
        {

            // Câu lệnh SQL để lấy dữ liệu từ bảng TapLuat
            string query = "SELECT TrongLuongVungID, NDtrongluongvung FROM [TRONGLUONGVUNG]"; // Chỉ lấy những cột cần thiết
        ...
        private void AddColumnsToDataGridView()
        {
            ...
            if (dataGridView_DanhSach.Columns.Count == 0)
            {
                ...
                colLuatID.Name = "TrongLuongVungID";
                colLuatID.HeaderText = "Mã Mục Đích";
                colLuatID.Width = 50;
                colLuatID.DataPropertyName = "TrongLuongVungID";  // Đảm bảo này khớp với tên cột trong DataTable
                dataGridView_DanhSach.Columns.Add(colLuatID);

                // Thêm cột "NoiDung"
                DataGridViewTextBoxColumn colNoiDung = new DataGridViewTextBoxColumn();
                colNoiDung.Name = "NDtrongluongvung";
                colNoiDung.HeaderText = "Nội Dung";
                colNoiDung.Width = 250;
                colNoiDung.DataPropertyName = "NDtrongluongvung"; // Đảm bảo này khớp với tên cột trong DataTable
        ...
        private void dataGridView_DanhSach_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            if (e.RowIndex >= 0)
            {
                ...
                if (row.Cells["TrongLuongVungID"].Value != null && row.Cells["NDtrongluongvung"].Value != null)
                {
                    // Hiển thị giá trị vào các TextBox
                    guna2TextBox_IDSuKien.Text = row.Cells["TrongLuongVungID"].Value.ToString();
                    guna2TextBox_NDSuKien.Text = row.Cells["NDtrongluongvung"].Value.ToString();
        ...
        private void guna2Button_Them_Click(object sender, EventArgs e)
        {
            ...
            string checkQuery = $"SELECT COUNT(*) FROM [TRONGLUONGVUNG] WHERE TrongLuongVungID = '{mucDichID}' OR NDtrongluongvung = N'{ndMucDich}'";
            ...
            try
            {
                ...
                string insertQuery = $"INSERT INTO [TRONGLUONGVUNG] (TrongLuongVungID, NDtrongluongvung) VALUES ('{mucDichID}', N'{ndMucDich}')";
        ...
        private void guna2Button_SuaLuat_Click(object sender, EventArgs e)
        {
            ...
            string checkQuery = $"SELECT COUNT(*) FROM [TRONGLUONGVUNG] WHERE NDtrongluongvung = N'{ndMucDich}' AND TrongLuongVungID != '{mucDichID}'";
            ...
            try
            {
                ...
                string updateQuery = $"UPDATE [TRONGLUONGVUNG] SET NDtrongluongvung = N'{ndMucDich}' WHERE TrongLuongVungID = '{mucDichID}'";
        ...
        private void guna2Button_XoaLuat_Click(object sender, EventArgs e)
        {
            ...
            if (dialogResult == DialogResult.Yes)
            {
                ...
                string query = $"DELETE FROM [TRONGLUONGVUNG] WHERE TrongLuongVungID = '{luatID}'";
        ...
        private void TimKiem()
        {
            ...
            string query = "SELECT TrongLuongVungID, NDtrongluongvung FROM [TRONGLUONGVUNG]";
            ...
            dv.RowFilter = string.Format("TrongLuongVungID LIKE '%{0}%' OR NDtrongluongvung LIKE '%{0}%'", searchKeyword); // Lọc theo LuatID và NoiDung
