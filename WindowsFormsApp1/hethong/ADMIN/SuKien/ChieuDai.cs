...
{
    public partial class ChieuDai : Form
    {
        ...
        private void ChieuDai_Load(object sender, EventArgs e)
        {
            // Câu lệnh SQL để lấy dữ liệu từ bảng TapLuat
            string query = "SELECT ChieuDaiID, NDchieudai FROM [CHIEUDAI]"; // Chỉ lấy những cột cần thiết
        ...
        private void AddColumnsToDataGridView()
        {
            ...
            if (dataGridView_DanhSach.Columns.Count == 0)
            {
                ...
                colLuatID.Name = "ChieuDaiID";
                colLuatID.HeaderText = "Mã Mục Đích";
                colLuatID.Width = 50;
                colLuatID.DataPropertyName = "ChieuDaiID";  // Đảm bảo này khớp với tên cột trong DataTable
                dataGridView_DanhSach.Columns.Add(colLuatID);

                // Thêm cột "NoiDung"
                DataGridViewTextBoxColumn colNoiDung = new DataGridViewTextBoxColumn();
                colNoiDung.Name = "NDchieudai";
                colNoiDung.HeaderText = "Nội Dung";
                colNoiDung.Width = 250;
                colNoiDung.DataPropertyName = "NDchieudai"; // Đảm bảo này khớp với tên cột trong DataTable
        ...
        private void dataGridView_DanhSach_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            if (e.RowIndex >= 0)
            {
                ...
                if (row.Cells["ChieuDaiID"].Value != null && row.Cells["NDchieudai"].Value != null)
                {
                    // Hiển thị giá trị vào các TextBox
                    guna2TextBox_IDSuKien.Text = row.Cells["ChieuDaiID"].Value.ToString();
                    guna2TextBox_NDSuKien.Text = row.Cells["NDchieudai"].Value.ToString();
        ...
        private void guna2Button_Them_Click(object sender, EventArgs e)
        {
            ...
            string checkQuery = $"SELECT COUNT(*) FROM [CHIEUDAI] WHERE ChieuDaiID = '{mucDichID}' OR NDchieudai = N'{ndMucDich}'";
            ...
            try
            {
                ...
                string insertQuery = $"INSERT INTO [CHIEUDAI] (ChieuDaiID, NDchieudai) VALUES ('{mucDichID}', N'{ndMucDich}')";
        ...
        private void guna2Button_SuaLuat_Click(object sender, EventArgs e)
        {
            ...
            string checkQuery = $"SELECT COUNT(*) FROM [CHIEUDAI] WHERE NDchieudai = N'{ndMucDich}' AND ChieuDaiID != '{mucDichID}'";
            ...
            try
            {
                ...
                string updateQuery = $"UPDATE [CHIEUDAI] SET NDchieudai = N'{ndMucDich}' WHERE ChieuDaiID = '{mucDichID}'";
        ...
        private void guna2Button_XoaLuat_Click(object sender, EventArgs e)
        {
            ...
            if (dialogResult == DialogResult.Yes)
            {
                ...
                string query = $"DELETE FROM [CHIEUDAI] WHERE ChieuDaiID = '{luatID}'";
        ...
        private void TimKiem()
        {
            ...
            string query = "SELECT ChieuDaiID, NDchieudai FROM [CHIEUDAI]";
            ...
            dv.RowFilter = string.Format("ChieuDaiID LIKE '%{0}%' OR NDchieudai LIKE '%{0}%'", searchKeyword); // Lọc theo LuatID và NoiDung
