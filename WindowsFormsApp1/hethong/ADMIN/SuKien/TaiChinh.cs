...
namespace WindowsFormsApp1.hethong.ADMIN.SuKien
{
    public partial class TaiChinh : Form
    {
        ...
        private void TaiChinh_Load(object sender, EventArgs e)
        {
            ...
            string query = "SELECT TaiChinhID, NDtaichinh FROM [TAICHINH]"; // Chỉ lấy những cột cần thiết
        ...
        private void AddColumnsToDataGridView()
        {
            ...
            if (dataGridView_DanhSach.Columns.Count == 0)
            {
                ...
                colLuatID.Name = "TaiChinhID";
                colLuatID.HeaderText = "Mã Mục Đích";
                colLuatID.Width = 50;
                colLuatID.DataPropertyName = "TaiChinhID";  // Đảm bảo này khớp với tên cột trong DataTable
                dataGridView_DanhSach.Columns.Add(colLuatID);

                // Thêm cột "NoiDung"
                DataGridViewTextBoxColumn colNoiDung = new DataGridViewTextBoxColumn();
                colNoiDung.Name = "NDtaichinh";
                colNoiDung.HeaderText = "Nội Dung";
                colNoiDung.Width = 250;
                colNoiDung.DataPropertyName = "NDtaichinh"; // Đảm bảo này khớp với tên cột trong DataTable
        ...
        private void dataGridView_DanhSach_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            if (e.RowIndex >= 0)
            {
                ...
                if (row.Cells["TaiChinhID"].Value != null && row.Cells["NDtaichinh"].Value != null)
                {
                    // Hiển thị giá trị vào các TextBox
                    guna2TextBox_IDSuKien.Text = row.Cells["TaiChinhID"].Value.ToString();
                    guna2TextBox_NDSuKien.Text = row.Cells["NDtaichinh"].Value.ToString();
        ...
        private void guna2Button_Them_Click(object sender, EventArgs e)
        {
            ...
            string checkQuery = $"SELECT COUNT(*) FROM [TAICHINH] WHERE TaiChinhID = '{mucDichID}' OR NDtaichinh = N'{ndMucDich}'";
            ...
            try
            {
                ...
                string insertQuery = $"INSERT INTO [TAICHINH] (TaiChinhID, NDtaichinh) VALUES ('{mucDichID}', N'{ndMucDich}')";
        ...
        private void guna2Button_SuaLuat_Click(object sender, EventArgs e)
        {
            ...
            string checkQuery = $"SELECT COUNT(*) FROM [TAICHINH] WHERE NDtaichinh = N'{ndMucDich}' AND TaiChinhID != '{mucDichID}'";
            ...
            try
            {
                ...
                string updateQuery = $"UPDATE [TAICHINH] SET NDtaichinh = N'{ndMucDich}' WHERE TaiChinhID = '{mucDichID}'";
        ...
        private void guna2Button_XoaLuat_Click(object sender, EventArgs e)
        {
            ...
            if (dialogResult == DialogResult.Yes)
            {
                ...
                string query = $"DELETE FROM [TAICHINH] WHERE TaiChinhID = '{luatID}'";
        ...
        private void TimKiem()
        {
            ...
            string query = "SELECT TaiChinhID, NDtaichinh FROM [TAICHINH]";
            ...
            dv.RowFilter = string.Format("TaiChinhID LIKE '%{0}%' OR NDtaichinh LIKE '%{0}%'", searchKeyword); // Lọc theo LuatID và NoiDung
