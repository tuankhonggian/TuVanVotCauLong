...
{
    public partial class PhanLoaiNguoi : Form
    {

        ketnoiDN ketnoi = new ketnoiDN();
        public PhanLoaiNguoi()
        {
            InitializeComponent();
        ...
        private void PhanLoaiNguoi_Load(object sender, EventArgs e)
        {
            // Câu lệnh SQL để lấy dữ liệu từ bảng TapLuat
            string query = "SELECT PhanLoaiNguoiID, NDphanloainguoi FROM [PHANLOAINGUOI]"; // Chỉ lấy những cột cần thiết
        ...
        private void AddColumnsToDataGridView()
        {
            ...
            if (dataGridView_DanhSach.Columns.Count == 0)
            {
                ...
                colLuatID.Name = "PhanLoaiNguoiID";
                colLuatID.HeaderText = "Mã Mục Đích";
                colLuatID.Width = 50;
                colLuatID.DataPropertyName = "PhanLoaiNguoiID";  // Đảm bảo này khớp với tên cột trong DataTable
                dataGridView_DanhSach.Columns.Add(colLuatID);

                // Thêm cột "NoiDung"
                DataGridViewTextBoxColumn colNoiDung = new DataGridViewTextBoxColumn();
                colNoiDung.Name = "NDphanloainguoi";
                colNoiDung.HeaderText = "Nội Dung";
                colNoiDung.Width = 250;
                colNoiDung.DataPropertyName = "NDphanloainguoi"; // Đảm bảo này khớp với tên cột trong DataTable
        ...
        private void dataGridView_DanhSach_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            if (e.RowIndex >= 0)
            {
                ...
                if (row.Cells["PhanLoaiNguoiID"].Value != null && row.Cells["NDphanloainguoi"].Value != null)
                {
                    // Hiển thị giá trị vào các TextBox
                    guna2TextBox_IDSuKien.Text = row.Cells["PhanLoaiNguoiID"].Value.ToString();
                    guna2TextBox_NDSuKien.Text = row.Cells["NDphanloainguoi"].Value.ToString();
        ...
        private void guna2Button_Them_Click(object sender, EventArgs e)
        {
            ...
            string checkQuery = $"SELECT COUNT(*) FROM [PHANLOAINGUOI] WHERE PhanLoaiNguoiID = '{mucDichID}' OR NDphanloainguoi = N'{ndMucDich}'";
            ...
            try
            {
                ...
                string insertQuery = $"INSERT INTO [PHANLOAINGUOI] (PhanLoaiNguoiID, NDphanloainguoi) VALUES ('{mucDichID}', N'{ndMucDich}')";
        ...
        private void guna2Button_SuaLuat_Click(object sender, EventArgs e)
        {
            ...
            string checkQuery = $"SELECT COUNT(*) FROM [PHANLOAINGUOI] WHERE NDphanloainguoi = N'{ndMucDich}' AND PhanLoaiNguoiID != '{mucDichID}'";
            ...
            try
            {
                ...
                string updateQuery = $"UPDATE [PHANLOAINGUOI] SET NDphanloainguoi = N'{ndMucDich}' WHERE PhanLoaiNguoiID = '{mucDichID}'";
        ...
        private void guna2Button_XoaLuat_Click(object sender, EventArgs e)
        {
            ...
            if (dialogResult == DialogResult.Yes)
            {
                ...
                string query = $"DELETE FROM [PHANLOAINGUOI] WHERE PhanLoaiNguoiID = '{luatID}'";
        ...
        private void TimKiem()
        {
            ...
            string query = "SELECT PhanLoaiNguoiID, NDphanloainguoi FROM [PHANLOAINGUOI]";
            ...
            dv.RowFilter = string.Format("PhanLoaiNguoiID LIKE '%{0}%' OR NDphanloainguoi LIKE '%{0}%'", searchKeyword); // Lọc theo LuatID và NoiDung
