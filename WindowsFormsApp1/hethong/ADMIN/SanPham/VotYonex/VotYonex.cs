...
{
    public partial class VotYonex : Form
    {
        public VotYonex()
        {
            InitializeComponent();
        ...
        private void VotYonex_Load(object sender, EventArgs e)
        {
        ...
        private void guna2Button_LamMoi_Click_1(object sender, EventArgs e)
        {
            // Đặt lại ô tìm kiếm
        ...
        private void guna2Button_Them_Click(object sender, EventArgs e)
        {
            ...
            if (themSPForm.ShowDialog() == DialogResult.OK)
            {
        ...
        private void gunuHighligh_TimKiem_KeyDown_1(object sender, KeyEventArgs e)
        {
        ...
        private void guna2ComboBox_TKgia_SelectedIndexChanged_1(object sender, EventArgs e)
        {
        ...
        private void gunuHighligh_TimKiem_TextChanged_1(object sender, EventArgs e)
        {
            TimKiemSanPham();
        }
