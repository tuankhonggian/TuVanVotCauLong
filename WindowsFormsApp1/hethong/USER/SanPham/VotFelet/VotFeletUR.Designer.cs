namespace WindowsFormsApp1.hethong.USER.SanPham.VotFelet
{
    partial class VotFeletAD
    {
        /// <summary>
        ...
        {
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(VotFeletAD));
            ...
            this.Name = "VotFeletUR";
            this.Text = "VotFeletUR";
            this.Load += new System.EventHandler(this.VotFeletUR_Load);
