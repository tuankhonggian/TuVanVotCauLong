namespace WindowsFormsApp1.hethong.USER.SanPham.VotKumpoo
{
    partial class VotKumpooAD
    {
        /// <summary>
        ...
        {
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(VotKumpooAD));
            ...
            this.Name = "VotKumpooUR";
            this.Text = "VotKumpooUR";
            this.Load += new System.EventHandler(this.VotKumpooUR_Load);
