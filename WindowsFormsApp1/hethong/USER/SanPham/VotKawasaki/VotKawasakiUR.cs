...
{
    public partial class VotKawasakiAD : Form
    {
        public VotKawasakiAD()
        {
            InitializeComponent();
        ...
        private DataTable LayDanhSachSanPham()
        {
            ...
            string query = "SELECT * FROM [Vot] WHERE ThuongHieu = 'Kawasaki' ";
        ...
        private void VotKawasakiUR_Load(object sender, EventArgs e)
        {
