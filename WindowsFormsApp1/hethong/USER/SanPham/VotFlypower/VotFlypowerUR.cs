...
{
    public partial class VotFlypowerAD : Form
    {
        public VotFlypowerAD()
        {
            InitializeComponent();
        ...
        private DataTable LayDanhSachSanPham()
        {
            ...
            string query = "SELECT * FROM [Vot] WHERE ThuongHieu = 'Flypower' ";
        ...
        private void VotFlypowerUR_Load(object sender, EventArgs e)
        {
